...
- [captainkvm.com 🌟🌟🌟](http://captainkvm.com)
    - [twitter.com/CaptainKVM 🌟🌟🌟](https://twitter.com/CaptainKVM)
...
- [Modernizing virtualization to save time and money 🌟🌟](https://www.redhat.com/en/about/blog/modernizing-virtualization-save-time-and-money) Many of today’s virtualized infrastructures are not operated as densely as they could be. IDC’s Al Gillen noted at Directions 2016 in April that, “VM density is stalling at about 10 VMs per server and somewhere between 30 to 50 percent utilization.” This is certainly an improvement over the 10 to 15 percent utilizations that were frequently quoted for physical servers pre-virtualization, but it’s not as high as it could be.
- [Red Hat Powers New Generation of High-performance virtualization based on open standards with Red Hat Virtualization 4](https://www.redhat.com/en/about/press-releases/red-hat-powers-new-generation-high-performance-virtualization-based-open-standards-red-hat-virtualization-4) KVM-based virtualization platform designed to streamline the virtualization of traditional workloads while providing a more secure and scalable foundation for hybrid cloud and container-based workloads
